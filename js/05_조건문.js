...
function check1() {
  ...
  // id가 "input1"인 요솔르 얻어와 input1 변수에 저장
...
function ageCheck() {
  ...
  else if (14 <= value && 19 >= value) {
    result = "청소년";
  }

  else if (20 <= value && 120 >= value) {
    result = "성인";
  }
...
function check5(){
  ...
  if(a.value.length === 0 || b.value.length === 0){
    ...
    return; // Early Reuturn : 함수를 여기서 일찍 끝냄
  }
