...
/** 입력 받은 단 거꾸로 출력하기 */
function check12(){
  const a = document.getElementById("dan12");
  const v1 = Number(a.value);
...
function check24(){
  ...
  // id가 "result24"인 요소에 내용으로 html 변수 값 추사
  // + HTML 태그 해석
